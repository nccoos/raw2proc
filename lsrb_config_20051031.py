platform_info = {
    ...
    'mean_water_depth' : -25.86, # meters (-) down, (+) up
    'mean_water_depth_time_period' : 'Oct 2005 - Feb 2006',
    'institution' : 'nccoos',
    # 
    'config_start_date' : '2005-10-31 00:00:00',
    'config_end_date' : '2006-02-19 00:00:00', # None or yyyy-mm-dd HH:MM:SS
    'packages' : ('adcp',),
    }
sensor_info = {
    'adcp' : { 'id' : 'adcp',
               'description' : 'Current profile data',
               'raw_dir' : '/seacoos/data/nccoos/level0/lsrb/adcp_bLogData/2005_10',
