platform_info = {
    ...
    'mean_water_depth' : -26.98, # meters (-) down, (+) up
    'mean_water_depth_time_period' : 'Aug 2007 - Sep 2007',
    'institution' : 'nccoos',
    # 
    'config_start_date' : '2007-06-12 00:00:00',
    'config_end_date' : '2007-07-22 00:00:00', # None or yyyy-mm-dd HH:MM:SS
    'packages' : ('adcp',),
    }
sensor_info = {
    'adcp' : { 'id' : 'adcp',
               'description' : 'Current profile data',
               'raw_dir' : '/seacoos/data/nccoos/level0/lsrb/adcp_bLogData/2007_06',
