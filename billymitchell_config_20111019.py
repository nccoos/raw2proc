#
# Increase number of altitudes to 39 (from 10 - 200 meters)
#
platform_info = {
    'id' : 'billymitchell',
    ...
    'institution' : 'nccoos',
    'config_start_date' : '2011-10-19 20:30:00',
    'config_end_date' : '2011-10-28 23:30:00', # None or yyyy-mm-dd HH:MM:SS
    'packages' : ('sfas',),
    }
sensor_info = {
    'sfas' : { 'id' : 'sodar',
