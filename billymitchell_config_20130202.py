#
# Increase sensor elevation by 1 meter (to 1 meter)
#
platform_info = {
    'id' : 'billymitchell',
    ...
    'mvar' : -10.816667,      # degrees (-) west, (+) east
    'institution' : 'nccoos',
    'config_start_date' : '2013-02-02 00:30:00',
...
sensor_info = {
    'sfas' : { 'id' : 'sodar',
               ...
               'num_altitudes' : 39,
               'sensor_elevation' : 1,   # meters (runway elev is at 5.2 m)
