platform_info = {
 	    ...
 	    'lat' : 34.7823,   # degrees true (-) south, (+) north
 	    'lon' : -75.9412,  # degrees true (-) west, (+) east
 	    'mvar' : -10.4,    # degrees (-) west, (+) east
            'altitude': 0.,   # (approx.) station altitude
            'altitude_units' : 'm',
            'altitude_reference' : 'sea_surface',
            #
            'mean_water_depth': -30, # meters (96 feet)
            'mean_water_depth_time_period': 'Not determined',
 	    'institution' : 'nccoos',
 	    #
 	    'config_start_date' : '2017-04-20 18:00:00',
 	    'config_end_date' : '2017-04-24 12:23:59', # None or yyyy-mm-dd HH:MM:SS
...
sensor_info = {
    ...
    'wind' : { 'id' : 'wind',
              ...
              'height_units' : 'm',
              'height_reference' : 'sea_surface',
               # Required offset corrections wdir1-wdir2 = 16
               # wdir1 looks okay for this time period from other nearest neighbors
               # 2017-04-20 18:00:00 until 2017-04-24 12:24:00 (see next config file for change in offset)
               'offset_vars' : ('wdir2',),
               'offset_vals' : (16.0,),
               # Recommended
